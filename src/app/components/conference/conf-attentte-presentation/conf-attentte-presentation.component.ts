...
import AgoraRTC, { IAgoraRTCClient, IAgoraRTCRemoteUser, VideoPlayerConfig } from 'agora-rtc-sdk-ng';
...
agoraToken: string = '007eJxTYLDuETT0M11ilyglX7Jt85Y9XD0XxPVeB2ebTrMULl7/QEGBIcnI1MwozSTJLMXSxMQsKcXSwjDNMNncIMUy2cDM1NLUKWxjSkMgI0PLry/MjAwQCOJzMCTn56W5JhanMjAAANe8Hok=';
constructor() {}
...
joinAgoraChannel() {
this.agoraClient!.join(this.agoraAppId, this.agoraChannelName,this.agoraToken);
}
